...
# Test JSON string WITH spaces but NO colons
...
json_str = json.dumps(payload, ensure_ascii=False) # Includes spaces by default
json_no_colon = json_str.replace(":", "=")

test_string("JSON WITH spaces NO colons", json_no_colon)
